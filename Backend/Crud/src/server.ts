...
import { swaggerUi, swaggerSpec } from "./swagger.js"; // importa lo que creaste

import logger from "./Services/logs.service.js";
import connectToDB from "./Database/conect.js";
import router_crud_user from "./Routers/crud_user.js";
import router_seguridad from "./Routers/seguridad.js";
import router_crud_chats from "./Routers/crud_chats.js";
